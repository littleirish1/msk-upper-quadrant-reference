...
const forbidden = [
  ...
  'V1-CRITICAL-INDEPENDENT-REVIEW-ADOPTION',
  'OWNER-CONFIRMED RECOMMENDATION IMPLEMENTED',
  'V1-MAJOR-INDEPENDENT-REVIEW-ADOPTION',
  'OWNER-CONFIRMED MAJOR RECOMMENDATION IMPLEMENTED',
  'V1-FINAL-20-CONDITION-HUMAN-CONFIRMATION',
  'record-v1-final-condition-confirmation',
  'v1-final-20-condition-human-confirmation',
  'confirmationRevisionKey',
  'private-anatomy-3d-upstream-comparison',
  'private-anatomy-3d-attribution-template',
